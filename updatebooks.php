...
if (isset($_POST["submit"])) {
    ...
    if ($update) {
        echo "<script>alert('Book updated succesfull!'); window.location.href='addbooks.php';</script>";
    } else {
        echo "<script>alert('Book update unsuccesfull! pls try after some minutes');</script>";
    }
}
?>
<!DOCTYPE HTML>
                ...
                <div class="main-page">
                    ...
                    <div class="row widgettable">
                        <div style="width:100%; height: 100%; margin-left:0px;  margin-top: 30px !important;" class="col-md-12 general-grids grids-right widget-shadow">
                            <h4 class="title2">UPDATE BOOK</h4>
                                        ...
                                        <div class="form-body">
                                            <form action="" method="post" enctype="multipart/form-data"> 
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" value="<?php echo $bkname ?>" name="bkname" class="form-control" id="exampleInputEmail1" placeholder="Book Name e.g INTRODUCTION TO COMPUTER"> 
                                                </div> 
                                                <div class="form-group"> 
                                                    <label for="exampleInputPassword1">Author(s)</label> 
                                                    <input type="text" value="<?php echo $bkauthor ?>" name="bkauthor" class="form-control" id="exampleInputPassword1" placeholder="Book Authors e.g John Doe"> 
                                                </div> 
                                                <div class="form-group"> 
                                                    <label for="exampleInputPassword1">Book Description</label> 
                                                    <textarea name="bkdesc" class="form-control" rows="4" placeholder="Enter book Description Here"><?php echo $bkdesc ?></textarea>
                                                </div>                                              
                                                <button type="submit" name="submit" class="btn btn-default">Update Book</button> 
                                            </form> 
                                        </div>
                                    </div>  
                                </div> 
